...
function renderTicketStatus(){$('#last-bible-ticket').hidden=!state.ticket;$('#bible-ticket-status').textContent=state.ticket?'上张小票 · '+(labels[state.ticket.status]||state.ticket.status):'';}
